...
class FileIoJsonImplSpec extends AnyWordSpec with Matchers {
  val testFilePath = "src/test/scala/de/htwg/se/blokus/models/fileIoImpl/test.json" // Pfad zur Testdatei

  "FileIoJsonImpl" should {

...
class BlockSpec extends FlatSpec with Matchers {
  ...
  "A Block" should "correctly create the base forms" in {
  ...
  it should "correctly create a block with rotation and mirroring" in {
    val blockType = 1
    val rotation = 2
    val mirrored = true
  ...
  it should "correctly create a block without rotation and mirroring" in {
    val blockType = 5
    val rotation = 0
    val mirrored = false
  ...
  it should "throw an exception when creating a block with an invalid blockType" in {
    val blockType = 20
    val rotation = 0
    val mirrored = false
